...
def filter_mutual_functional(mutual_exclusion_constraint,functional_constraint):
    # print(mutual_exclusion_constraint)
    merged_constraint_list=mutual_exclusion_constraint
    mutual_relation=[]
    for c in mutual_exclusion_constraint:
        relation=c.split(",")[1]
        mutual_relation.append(relation)
    for c in functional_constraint:
        relation=c.split(",")[1]
        if relation not in mutual_relation:
            merged_constraint_list.append(c)
...
def Constraint_Mining(graph):
    ...
    print("Candidate Constraint list:")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--typefile', metavar='FILE', default='', help='entity type infomation file needed during refinement')
    parser.add_argument('--support', metavar='Number', type=int, default=100, help='constraint support')
    parser.add_argument('--candidate_confidence', metavar='Number', type=float, default=0.5, help='constraint candidate confidence')
